...
<div id="page-wrapper">
  <div id="page">
    <div class="container">
  <header id="header" role="banner" class="<?php print $secondary_menu ? 'with-secondary-menu': 'without-secondary-menu'; ?>">
  ...
  <?php if ($page['content_area']): ?>
    <div id="content_area"><div class="section clearfix">
      <?php print render($page['content_area']); ?>
    </div></div> <!-- /.section, /#featured -->
  <?php endif; ?>
